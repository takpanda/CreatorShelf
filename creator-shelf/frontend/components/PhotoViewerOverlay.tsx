...
import { X, Heart, ChevronLeft, ChevronRight, Maximize2 } from "lucide-react";
...
export default function PhotoViewerOverlay({ mediaId, creatorId, onClose }: Props) {
