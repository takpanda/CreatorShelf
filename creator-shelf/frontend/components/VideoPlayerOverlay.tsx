...
import { X, Heart, ChevronLeft, ChevronRight, Repeat, Repeat1 } from "lucide-react";
...
export default function VideoPlayerOverlay({ mediaId, creatorId, onClose }: Props) {
  ...
  useEffect(() => {
    ...
    container.scrollTo({ top: item.offsetTop + item.offsetHeight / 2 - container.clientHeight / 2, behavior: "smooth" });
  }, [current]);
